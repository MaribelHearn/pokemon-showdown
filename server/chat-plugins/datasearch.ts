...
export const commands: Chat.ChatCommands = {
	...
	dexsearchhelp() {
		this.sendReply(
			...
			`Valid tiers are: Uber/OU/UUBL/UU/RUBL/RU/NUBL/NU/PUBL/PU/ZU/NFE/LC/CAP/CAP NFE/CAP LC/Fundex Uber/Fundex OU/Fundex LC.<br/>` +
	...
	movesearchhelp() {
		this.sendReply(
			...
			`Valid flags are: bypasssub (bypasses substitute), bite, bullet, cantusetwice, charge, contact, dance, defrost, gravity, mirror (reflected by mirror move), ohko, powder, priority, protect, pulse, punch, recharge, recovery, reflectable, secondary, snatch, sound, zmove, pivot, and multi-hit.<br/>` +
...
function runDexsearch(target: string, cmd: string, canAll: boolean, message: string, isTest: boolean) {
	...
	const allTiers: {[k: string]: TierTypes.Singles | TierTypes.Other} = Object.assign(Object.create(null), {
		...
		fundexuber: 'Fundex Uber', fundexou: 'Fundex OU', fundexlc: 'Fundex LC',
	});
...
function runMovesearch(target: string, cmd: string, canAll: boolean, message: string, isTest: boolean) {
	...
	const allFlags = [
		'bypasssub', 'bite', 'bullet', 'cantusetwice', 'charge', 'contact', 'dance', 'defrost', 'gravity', 'highcrit',
