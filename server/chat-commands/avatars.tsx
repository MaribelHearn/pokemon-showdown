...
export const Avatars = new class {
	...
	src(avatar: AvatarID) {
		...
		return `https://raw.githubusercontent.com/MaribelHearn/pokemon-showdown-sprites/master/sprites/${avatarUrl}`;
	}
...
const OFFICIAL_AVATARS = new Set([
	...
	'zinzolin',
	// Fundex: Quartz Minus avatars
	'j-akira', 'ran', 'betti', 'fausto', 'max', 'nieves', 'benito', 'lorenzo', 'danny', 'nadia', 'arturo',
	'roco', 'perica', 'colombo', 'martha', 'annie', 'band-ambar-grunt', 'ambrosio', 'elektra', 'amber',
]);
