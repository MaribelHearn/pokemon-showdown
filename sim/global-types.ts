...
type Nonstandard = 'Past' | 'Future' | 'Unobtainable' | 'CAP' | 'LGPE' | 'Custom' | 'Gigantamax' | 'Fundex';
...
namespace TierTypes {
	...
	export type Other = "Unreleased" | "Illegal" | "CAP" | "CAP NFE" | "CAP LC" | "Fundex Uber" | "Fundex OU" | "Fundex LC";
}
