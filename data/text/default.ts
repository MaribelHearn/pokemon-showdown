export const DefaultText: {[k: string]: DefaultText} = {
	default: {
		...
		megaBowser: "[POKEMON] used his Final Smash!",
		megaMaribel: "[POKEMON] lost control over her powers and went berserk!",
		megaVIVIT: "[POKEMON] consumed the Saboten Energy from her bottle!",
		megaGrandma1: "[POKEMON] ate the Wrath Cookie and became angered!",
