...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: ['All Pokemon', 'Max Strike', 'Max Knuckle', 'Max Airstream', 'Max Ooze', 'Max Quake', 'Max Rockfall', 'Max Flutterby', 'Max Phantasm', 'Max Steelspike', 'Max Flare',
			'Max Geyser', 'Max Overgrowth', 'Max Lightning', 'Max Mindstorm', 'Max Hailstorm', 'Max Wyrmwind', 'Max Darkness', 'Max Starfall', 'Max Guard', 'Frenzy', 'Lucky', 'Ruin', 'Clot', 'blab',
			'Master Ball', 'Ultra Ball', 'Great Ball', 'Poke Ball', 'Safari Ball', 'Net Ball', 'Dive Ball', 'Nest Ball', 'Repeat Ball', 'Timer Ball',
			'Luxury Ball', 'Premier Ball', 'Dusk Ball', 'Heal Ball', 'Quick Ball', 'Cherish Ball', 'Dream Ball', 'Beast Ball', 'Sun Stone', 'Moon Stone', 'Fire Stone',
			'Thunder Stone', 'Water Stone', 'Leaf Stone', 'Root Fossil', 'Claw Fossil', 'Helix Fossil', 'Dome Fossil', 'Old Amber', 'Armor Fossil', 'Skull Fossil',
			'Shiny Stone', 'Dusk Stone', 'Dawn Stone', 'Oval Stone', 'Griseous Orb', 'Douse Drive', 'Shock Drive', 'Burn Drive', 'Chill Drive', 'Adamant Orb', 'Lustrous Orb',
			...
			'Black Hole Eclipse', 'Twinkle Tackle', 'Unreal Unraveling', 'Snake-Busted', 'Chuck Testa-Busted', 'Angry Wiggler'],
		unbanlist: ['Fundex'],
	},
	{
	...
	},
    {
		...
		banlist: ['Fundex Uber', 'All Pokemon', 'Bright Powder', 'King\'s Rock', 'Lax Incense', 'Razor Fang', 'Quick Claw', 'Shadow Tag', 'Baton Pass',
			...
			'TR76', 'TR77', 'TR78', 'TR79', 'TR80', 'TR81', 'TR82', 'TR83', 'TR84', 'TR85', 'TR86', 'TR87', 'TR88', 'TR89', 'TR90', 'TR91', 'TR92', 'TR93', 'TR94',
			'TR95', 'TR96', 'TR97', 'TR98', 'TR99', 'Fast Ball', 'Friend Ball', 'Heavy Ball', 'Level Ball', 'Love Ball', 'Lure Ball', 'Moon Ball', 'Park Ball',
			'tentaquil', 'Captain Falcon', 'Cell', 'Dennis', 'Zalgo', 'ROFLcopter', 'Andross', 'Slenderman', 'Baby Luigi', 'Luigi', 'Weegee', 'Matrix', 'Lolwut Pear',
			'Dr. Eggman', 'Leonidas', 'King Harkinian', 'Yarrow', 'Doomsday', 'Vegeta', 'Dr. Octogonapus', 'Ace Trainer', 'Crasher Wake', 'Young Link', 'Link', 'Young Zelda',
			'Zelda', 'Sheik', 'Ganondorf', 'Suiseiseki', 'Admiral Ackbar', 'Yoda', 'Darth Vader', 'Longcat', 'tacgnoL', 'oLngact', 'Orly-Owl', 'Cats', 'Raptor Jesus',
			'Leeroy Jenkins', 'Angry Bird', 'Big Brother', 'Giant Enemy Crab', 'Super Nerd', 'Leon Powalski', 'Trollface', 'S. A. Penguin', 'Missingno.', 'Missingno.-Ghost',
			'Missingno.-Aerodactyl', 'Missingno.-Kabutops', 'Missingno.-Yellow', 'Kirby', 'Meta Knight', 'King Dedede', 'Snake', 'Zero Suit Samus', 'Samus', 'Zeeky H. Bomb',
			...
			'Dry Bowser', 'Tesla', 'Nyan Cat', 'Baby Mario', 'Mario', 'Malleo', 'Boo', 'Boolossus', 'King Boo', 'Bouldergeist', 'GLaDOS', 'Bad EGG', 'Wiggler', 'Kanzou',
	...
	},
	{
		...
		ruleset: ['HP Percentage Mod', 'Cancel Mod', 'Dynamax Clause'],
		banlist: ['All Pokemon', 'Max Strike', 'Max Knuckle', 'Max Airstream', 'Max Ooze', 'Max Quake', 'Max Rockfall', 'Max Flutterby', 'Max Phantasm', 'Max Steelspike', 'Max Flare',
			'Max Geyser', 'Max Overgrowth', 'Max Lightning', 'Max Mindstorm', 'Max Hailstorm', 'Max Wyrmwind', 'Max Darkness', 'Max Starfall', 'Max Mystery', 'Max Guard', 'Frenzy', 'Lucky', 'Ruin', 'Clot', 'blab',
			'Master Ball', 'Ultra Ball', 'Great Ball', 'Poke Ball', 'Safari Ball', 'Net Ball', 'Dive Ball', 'Nest Ball', 'Repeat Ball', 'Timer Ball',
			'Luxury Ball', 'Premier Ball', 'Dusk Ball', 'Heal Ball', 'Quick Ball', 'Cherish Ball', 'Dream Ball', 'Beast Ball', 'Sun Stone', 'Moon Stone', 'Fire Stone',
			'Thunder Stone', 'Water Stone', 'Leaf Stone', 'Root Fossil', 'Claw Fossil', 'Helix Fossil', 'Dome Fossil', 'Old Amber', 'Armor Fossil', 'Skull Fossil',
			'Shiny Stone', 'Dusk Stone', 'Dawn Stone', 'Oval Stone', 'Griseous Orb', 'Douse Drive', 'Shock Drive', 'Burn Drive', 'Chill Drive', 'Adamant Orb', 'Lustrous Orb',
	...
	},
	{
		...
		banlist: [
			...
			'Healing Wish', 'Lunar Dance', 'Magic Room', 'Memento', 'Misty Explosion', 'Self-Destruct', 'Light Catnarok', 'Dark Catnarok', 'Fiery Catnarok', 'System Crash',
		],
		unbanlist: ['Fundex'],
		onValidateTeam(team) {
